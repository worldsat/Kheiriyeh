...
public class DeceasedNameListAdapter extends RecyclerView.Adapter<DeceasedNameListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_deceased_name_list, parent, false);
            ...
            popup.setOnMenuItemClickListener(item -> {
                switch (item.getItemId()) {
                    case R.id.popup_edit:
                        ...
                        Intent intent = new Intent(holder.itemView.getContext(), AddDeceasedNameActivity.class);
